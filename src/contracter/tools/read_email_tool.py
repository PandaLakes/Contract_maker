...
class GmailTool:
    ...
    def __init__(self):
        self.creds = None
        self.token_path = os.path.join(os.path.dirname(__file__), 'token_email.json')
    ...
    def get_latest_email(self):
        ...
        results = self.service.users().messages().list(userId='me', q='is:unread subject:contract').execute()
